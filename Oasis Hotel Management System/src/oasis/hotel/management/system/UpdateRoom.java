...
public class UpdateRoom extends JFrame implements ActionListener{
    ...
    UpdateRoom() {
        ...
        /*ImageIcon i1 = ImageIcon(ClassLoader.getSystemResource("icons/seventh.jpg"));
        ...
        if (ae.getSource() == check) {
            ...
            try {
                ...
                while(rs2.next()) {
                    ...
                    tfstatus.setText(rs2.getString("roomStatus"));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }       
            ...
            try{
                Conn c = new Conn();
                c.s.executeUpdate("update room set availability = '"+available+"', roomStatus = '"+status+"'where roomnumber ='"+room+"'");
